...
STOP_CLUSTER_MIN = _env_int("STOP_CLUSTER_MIN", 3)  # N published STOP_HIT on same side → suppress that side
...
def run_trade_scanner():
    ...
    logger.info(
        ...
        "min_score=%.1f stop_cluster_block=%s (burst via publication_gate)",
        already_today,
        MIN_PUBLISH_SCORE,
