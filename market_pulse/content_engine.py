...
def build_content_engine(
    ...
    cta_map = {
        ...
        "midday":  "📊 Full midday analysis with entry & stop is live in the Pro channel. Pro payment verification: WhatsApp +2347045850590. No trade questions.",
        "evening": "🌙 Get tomorrow's exact trade plan before you sleep — Pro channel. Pro payment verification: WhatsApp +2347045850590. No trade questions.",
        "weekly":  "🔥 Saturday Weekly Edge is live in the Pro channel — entry, stop, target for next week. Pro payment verification: WhatsApp +2347045850590. No trade questions.",
        "alert":   "⚡ Full key level analysis + trade setup is in the Pro channel right now. Pro payment verification: WhatsApp +2347045850590. No trade questions.",
    }
    results["cta"] = cta_map.get(post_type, "⚡ Full intelligence in the Pro channel. Pro payment verification: WhatsApp +2347045850590. No trade questions.")
