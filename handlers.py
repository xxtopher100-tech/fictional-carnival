...
from market_pulse.config_runtime import ADMIN_IDS, BOT_TOKEN, COINS, LOG_FILE, P2P_FIATS, SCHEDULE, load_admin_config, logger, save_admin_config
...
from market_pulse.menus import ACCOUNT_MENU_FREE, ACCOUNT_MENU_PRO, ADMIN_ANALYTICS_MENU, ADMIN_CHANNEL_MENU, ADMIN_MENU, ADMIN_SETTINGS_MENU, ADMIN_SYSTEM_MENU, ADMIN_TRADES_MENU, ADMIN_USERS_MENU, ALERTS_MENU_FREE, ALERTS_MENU_PRO, BACK_MAIN, INTELLIGENCE_MENU, MARKETS_MENU, P2P_MENU, PORTFOLIO_MENU, TOOLS_MENU, TRADES_MENU, get_user_badge
...
from market_pulse.pro_system import get_bot_mode, get_pro_days_left, get_pro_expiry, get_pro_referral_count, get_pro_referral_reward, grant_pro, is_pro, record_pro_referral, set_bot_mode
from market_pulse.screens import handle_position_calc, show_help, show_main_menu, show_market, show_portfolio, show_position_calculator, show_settings, show_trade_journal, show_upgrade
...
from market_pulse.trade_scanner import run_trade_scanner
...
def run():
    ...
    start_derivatives_engine(admin_notify=lambda msg: send(ADMIN_IDS[0], msg) if ADMIN_IDS else None)
